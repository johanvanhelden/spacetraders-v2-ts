...
export const FactionsApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getFaction(factionSymbol: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetFaction200Response>> {
            ...
            const operationBasePath = operationServerMap['FactionsApi.getFaction']?.[index]?.url;
        ...
        async getFactions(page?: number, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetFactions200Response>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['FactionsApi.getFactions']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
